...
| -------- | ---------------------- | ------- | ------------------------------------------------------------------------------------------------------------------------ |
| `intent` | `"info"` \| `"danger"` |         | Indicates the importance or impact level of the AlertDialog, affecting its color and styling to communicate its purpose. |
...
A button that confirms the Alert Dialog action. Defaults to `appearance="filled"` and the intent color from `AlertDialog.Root`. Does not close the alert dialog by default.
