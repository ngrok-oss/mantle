...
| Prop       | Type                                           | Default | Description                                                                                                                               |
| ---------- | ---------------------------------------------- | ------- | ----------------------------------------------------------------------------------------------------------------------------------------- |
| `intent`   | `"info" \| "success" \| "warning" \| "danger"` |         | The intent level of the toast, which determines the visual styling and default icon.                                                      |
...
The `Toast.Icon` displays an icon representing the toast intent. If no custom icon is provided, a default icon for the intent is used.

| Prop   | Type        | Default | Description                                                                                        |
| ------ | ----------- | ------- | -------------------------------------------------------------------------------------------------- |
| `svg?` | `ReactNode` |         | A custom SVG icon to display. If not provided, the default icon for the toast intent will be used. |
