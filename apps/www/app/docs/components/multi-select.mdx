    	...
    	<div className="flex w-full max-w-96 flex-col gap-4">
    		...
    		>
    			<MultiSelect.Trigger validation="success">
    				<MultiSelect.TagValues />
    				<MultiSelect.Input placeholder="Success state..." />
    			</MultiSelect.Trigger>
    			<MultiSelect.Content aria-busy={isPending}>
    				{matches.map((value) => (
    					<MultiSelect.Item key={value} value={value}>
    		...
    		>
    			<MultiSelect.Trigger validation="warning">
    				<MultiSelect.TagValues />
    				<MultiSelect.Input placeholder="Warning state..." />
    			</MultiSelect.Trigger>
    			<MultiSelect.Content aria-busy={isPending}>
    				{matches.map((value) => (
    					<MultiSelect.Item key={value} value={value}>
...
| Prop        | Type                                         | Default | Description                                                                                                                |
| :---------- | :------------------------------------------- | :------ | :------------------------------------------------------------------------------------------------------------------------- |
| `children?` | `(props: TagRenderProps) => React.ReactNode` |         | Render function for each tag. Receives `{ value, onRemove, ref }` — spread onto `TagOption` for full keyboard-nav support. |
