...
This is ideal for sharing a Traffic Policy or config snippet across multiple SDK examples without duplicating it. The fragment can live in the same module, or be imported from another module:
