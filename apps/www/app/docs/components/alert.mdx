...
| `intent`      | `"danger"` \| `"info"` \| `"success"` \| `"warning"` |             | Indicates the importance or impact level of the `Alert`, affecting its color and styling to communicate its purpose.                                                                                           |
...
An optional icon that visually represents the intent of the `Alert`. The default rendered icon can be overridden with a custom icon using the `svg` prop.

All props from [svg](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/svg#attributes), plus:

| Prop   | Type        | Default | Description                                                                        |
| ------ | ----------- | ------- | ---------------------------------------------------------------------------------- |
| `svg?` | `ReactNode` |         | An optional icon that renders in place of the default icon for the `Alert` intent. |
