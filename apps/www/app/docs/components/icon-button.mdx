...
<IconButton type="button" appearance="subtle" label="prestige worldwide" size="xs" icon={<GlobeIcon />} />
...
<IconButton type="button" appearance="subtle" label="prestige worldwide" size="sm" icon={<GlobeIcon />} />
...
<IconButton type="button" appearance="subtle" label="prestige worldwide" size="md" icon={<GlobeIcon />} />
...
| ------------ | --------------------------------------- | ------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `appearance` | `"ghost"` \| `"outlined"` \| `"subtle"` | `"outlined"` | Defines the visual style of the `IconButton`.                                                                                                                                                             |
