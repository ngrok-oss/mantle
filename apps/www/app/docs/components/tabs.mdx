...
<Example className="mt-4 grid gap-6">
    ...
    <Separator />
    <h2 className="text-lg">Horizontal overflow</h2>
    <p>
    	When the tab list overflows its container, it scrolls horizontally. Constrain the root width to
    	trigger this behavior.
    </p>
    <Tabs.Root orientation="horizontal" defaultValue="getting-started" className="max-w-lg">
    	<Tabs.List>
