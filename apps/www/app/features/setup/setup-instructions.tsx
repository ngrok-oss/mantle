...
const devDependenciesInstallationCommand = {
	npm: `npm install -DE ${devDeps}`,
	pnpm: `pnpm add -DE ${devDeps}`,
	bun: `bun add -DE ${devDeps}`,
} as const satisfies Record<PackageManager, string>;
...
/**
 * Interactive setup instructions for mantle, with package manager and
	...
	return (
		<section>
			...
			<section className="mt-8 space-y-4">
				...
				<ApplicationTemplateContent template={applicationTemplate} />
...
function ApplicationTemplateContent({ template }: { template: ApplicationTemplate }) {
	switch (template) {
		case "react-router":
