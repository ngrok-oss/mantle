...
- **Variable naming**: Always use descriptive, full names — never abbreviations or single-letter shortcuts. Apply this principle to all variables; the examples below are illustrative, not exhaustive:
