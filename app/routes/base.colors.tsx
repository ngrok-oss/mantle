		...
		<div className="relative flex flex-row-reverse gap-9">
			<nav className="sticky top-6 hidden w-44 self-start lg:block">
				...
				<ul className="mt-3 flex flex-col gap-2 text-sm text-muted">
					<li>
						<HashNavLink
							className={(isActive) => cx("hover:text-strong hover:font-medium", isActive && "font-medium text-accent")}
							to=".#tailwind"
						>
							Tailwind
						</HashNavLink>
					...
					<ul className="ml-4 flex flex-col gap-2">
						<li>
							<HashNavLink
								className={(isActive) =>
									cx("hover:text-strong hover:font-medium", isActive && "font-medium text-accent")
								}
								to=".#gray-branded"
							>
								Gray
