			...
			<ul role="list" className="flex flex-col">
				...
				<li>
					<NavLink
						className={({ isActive }) =>
							cx(
								"-ml-2 block rounded-lg px-2 py-1 text-sm text-gray-500 hover:font-medium hover:text-gray-800",
				...
				<ul role="list" className="mt-2 text-sm">
					<li>
						<NavLink
							className={({ isActive }) =>
								cx(
									"-ml-2 block rounded-lg px-2 py-1 text-gray-500 hover:font-medium hover:text-gray-800",
									isActive && "font-medium text-blue-600 hover:text-blue-600",
								)
							}
							to="/base/typography"
