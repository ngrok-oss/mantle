	...
	return (
		<DayPicker
			...
			classNames={{
				...
				day: "day sm:h-7 sm:w-7 h-7 w-7 rounded-md hover:bg-filled-accent/10",
				...
				day_range_middle: "day-range-middle aria-selected:bg-filled-accent/10 aria-selected:text-strong rounded-none aria-selected:hover:bg-filled-accent/20",
