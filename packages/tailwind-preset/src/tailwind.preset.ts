	...
	theme: {
		...
		extend: {
			...
			backgroundColor: {
				...
				"filled-blue-active": "hsl(var(--bg-filled-blue-active))",
				"filled-blue-hover": "hsl(var(--bg-filled-blue-hover))",
				"filled-blue": "hsl(var(--bg-filled-blue))",
				"filled-red-active": "hsl(var(--bg-filled-red-active))",
				"filled-red-hover": "hsl(var(--bg-filled-red-hover))",
				"filled-red": "hsl(var(--bg-filled-red))",
				"filled-gray-active": "hsl(var(--bg-filled-gray-active))",
				"filled-gray-hover": "hsl(var(--bg-filled-gray-hover))",
				"filled-gray": "hsl(var(--bg-filled-gray))",
				"filled-green-active": "hsl(var(--bg-filled-green-active))",
				"filled-green-hover": "hsl(var(--bg-filled-green-hover))",
				"filled-green": "hsl(var(--bg-filled-green))",
				"filled-amber-active": "hsl(var(--bg-filled-amber-active))",
				"filled-amber-hover": "hsl(var(--bg-filled-amber-hover))",
				"filled-amber": "hsl(var(--bg-filled-amber))",
			...
			ringColor: {
				"focus-blue": "hsl(var(--ring-focus-blue))",
				"focus-red": "hsl(var(--ring-focus-red))",
				"focus-gray": "hsl(var(--ring-focus-gray))",
				"focus-green": "hsl(var(--ring-focus-green))",
				"focus-amber": "hsl(var(--ring-focus-amber))",
			},
			cursor: {
				inherit: "inherit",
				initial: "initial",
