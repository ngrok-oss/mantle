	...
	theme: {
		...
		extend: {
			...
			textColor: {
				...
				"bg-neutral": "hsl(var(--text-on-bg-neutral))",
				"bg-accent": "hsl(var(--text-on-bg-accent))",
				"bg-danger": "hsl(var(--text-on-bg-danger))",
				"bg-warning": "hsl(var(--text-on-bg-warning))",
				"bg-success": "hsl(var(--text-on-bg-success))",
				"bg-neutral-muted": "hsl(var(--text-on-bg-neutral-muted))",
				"bg-accent-muted": "hsl(var(--text-on-bg-accent-muted))",
				"bg-danger-muted": "hsl(var(--text-on-bg-danger-muted))",
				"bg-warning-muted": "hsl(var(--text-on-bg-warning-muted))",
				"bg-success-muted": "hsl(var(--text-on-bg-success-muted))",
				"bg-tooltip": "hsl(var(--text-on-bg-tooltip))",
			},
			borderColor: {
