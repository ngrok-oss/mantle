	...
	theme: {
		...
		extend: {
			...
			backgroundColor: {
				...
				"primary-muted-hover": "hsl(var(--bg-accent-muted-hover))",
			...
			textColor: {
				...
				"bg-accent-muted": "hsl(var(--text-bg-accent-muted))",
			...
			borderColor: {
				...
				"primary-muted": "hsl(var(--border-accent-muted))",
