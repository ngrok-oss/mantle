...
>(({ asChild = false, className, onClick, ...props }, ref) => {
	...
	return (
		<Component
			...
			className={cx(
				"flex w-full items-center justify-center gap-0.5 border-t border-gray-300 bg-gray-50 px-4 py-2 font-sans text-gray-700 hover:bg-gray-100 cursor-pointer",
				className,
			)}
			ref={ref}
			type="button"
