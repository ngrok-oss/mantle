	...
	"inline-flex items-center justify-center rounded-md font-medium focus-visible:outline-none focus-visible:ring-4 disabled:pointer-events-none disabled:opacity-50 h-11 sm:h-9 px-3 border whitespace-nowrap sm:text-sm",
	{
		variants: {
			appearance: {
				...
				link: "border-transparent cursor-pointer hover:underline text-blue-600 active:bg-blue-500/10 focus-visible:ring-blue-500/25",
			},
			priority: {
				default: "",
				danger: "",
		...
		compoundVariants: [
			...
			},
			{
				appearance: "link",
				priority: "danger",
				class: "text-red-600 active:bg-red-500/10 focus-visible:ring-red-500/25",
			},
			{
				appearance: "ghost",
				priority: "muted",
			...
			},
			{
				appearance: "link",
				priority: "muted",
				class: "text-gray-900 active:bg-gray-500/10 focus-visible:ring-blue-500/25",
			},
		],
	},
);
