 ...
 */
export const MediaObject = forwardRef<HTMLDivElement, Props>(({ className, children, style }, ref) => (
 ...
 */
export const MediaObjectContent = forwardRef<HTMLDivElement, Props>(({ className, children, style }, ref) => (
