...
>(({ className, children, ...props }, ref) => (
	<SelectPrimitive.Trigger
		ref={ref}
		className={cx(
			"flex h-11 w-full items-center justify-between rounded-md border border-gray-300 bg-white px-3 py-2 placeholder:text-gray-300 hover:border-gray-400 hover:bg-gray-600/10 focus:border-blue-600 focus:outline-none focus:ring-4 focus:ring-blue-500/25 disabled:cursor-not-allowed disabled:opacity-50 dark:bg-gray-50 dark:hover:bg-gray-600/10 sm:h-9 sm:text-sm [&>span]:line-clamp-1 [&>span]:text-left",
			className,
		)}
		{...props}
	>
