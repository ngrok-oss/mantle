...
const inputVariants = cva(
	"flex h-11 w-full rounded-md border bg-form px-3 py-2 file:border-0 file:bg-transparent file:text-sm file:font-medium focus-visible:outline-none focus-visible:ring-4 disabled:pointer-events-none disabled:opacity-50 sm:h-9 sm:text-sm",
	{
		variants: {
			state: {
				default: "text-strong border-form placeholder:text-placeholder focus:border-accent-600 focus:ring-accent",
				danger: "border-danger-600 placeholder:text-placeholder focus:border-danger-600 focus:ring-danger",
			},
		},
		defaultVariants: {
			state: "default",
