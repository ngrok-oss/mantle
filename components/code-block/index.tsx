		...
		return (
			<button
				...
				className={cx(
					...
					copied &&
						"gap-1 w-auto border-transparent bg-green-500 focus:bg-green-500 pl-2 pr-1.5 text-white hover:border-transparent hover:bg-green-500 focus-visible:ring-green-600/25 focus-visible:border-green-600",
					className,
				)}
				ref={ref}
				style={style}
