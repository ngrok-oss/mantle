		...
		return (
			<button
				...
				className={cx(
					...
					copied &&
						"w-auto gap-1 border-transparent bg-filled-success pl-2 pr-1.5 text-inverted hover:border-transparent hover:bg-filled-success-hover focus:bg-filled-success-active focus-visible:border-success-600 focus-visible:ring-focus-success",
					className,
				)}
				ref={ref}
				style={style}
