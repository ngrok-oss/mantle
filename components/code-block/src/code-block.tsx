		...
		return (
			<button
				...
				className={cx(
					...
					copied &&
						"w-auto gap-1 border-transparent bg-success pl-2 pr-1.5 text-inverted hover:border-transparent hover:bg-success-hover focus:bg-success-active focus-visible:border-success-600 focus-visible:ring-focus-success",
					className,
				)}
				ref={ref}
				style={style}
